...
def chap_5(req_save, command, intent, user_id):
    ...
    COMMANDS_1 = ['нет','не хочу', 'не','никак','спать','умирать']
    if command in COMMANDS:
        ...
        req_save["save"] = "chap_5"
        text = '''Охранник приводит вас в чувства. Вам кажется, что прошло несколько часов, но вы не уверены. Вы пытаетесь подняться, но чувствуете резкую боль в голове и ощущение тошноты. Открыв глаза, вы замечаете, что на вашем лице красуется синяк, а на ваших руках видны следы ударов.\n
Вам нужно восстановить силы. Лечь спать?'''
        tts = '''Охранник приводит вас в чувства. Вам кажется, что прошло несколько часов, но вы не уверены. Вы пытаетесь подняться, но чувствуете резкую боль в голове и ощущение тошноты. Открыв глаза, вы замечаете, что на вашем лице красуется синяк, а на ваших руках видны следы ударов.\n
Вам нужно восстановить силы. Лечь спать?'''
        return message_sent(text=text, tts=tts, save=req_save, version=version)
    else:
