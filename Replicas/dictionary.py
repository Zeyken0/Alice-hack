main_data = {
    ...
    "chap2_3_2_1x": {
        "text": 'Чтобы выбрать оружие, скажите "Взять "Название предмета"". Чтобы посмотреть, какие предметы у вас есть, скажите "Открыть инвентарь".',
...
Чтобы срубить дерево, вам понадобится подходящий инструмент из вашего инвентаря. Для просмотра, предметов в вашем инвентаре, просто скажите "Инвентарь".''',
    ...
    "chap2_3_3_1": {
        "text": 'Вы выбрались из болота. Для продолжения ответьте на вопрос: Как лучше пересечь болото - поплыть на спине или использовать длинную палку для прощупывания дна?',
        "tts": 'Вы выбрались из болота. Для продолжения ответьте на вопрос: Как лучше пересечь болото - поплыть на спине или использовать длинную палку для прощупывания дна?',
        "buttons": [
            {
                "title": 'Поплыть на спине',
                "hide": True
            },
            {
                "title": 'Использовать длинную палку',
                "hide": True
            }
        ]
    },
...
Для продолжения скажите "Идти дальше".''',
    ...
    "chap2_3_0": {
        "text": 'Вы потеряли сознание. Для продолжения скажите "Очнуться".',
        "tts": 'Вы потеряли сознание. Для продолжения скажите "Очнуться".',
        "buttons": [
            {
                "title": 'Очнуться',
                "hide": True
    ...
    "chap2_17": {
        "text": '''Все руны загораются, но никаких изменений не происходит. Прикоснуться к стене?''',
        "tts": '''Все руны загораются, но никаких изменений не происходит. Прикоснуться к стене?''',
        "buttons": [
            {
                "title": 'Да',
                "hide": True
    ...
    "chap2_21": {
        ...
        "buttons": [
            {
                "title": 'Начать обучение магии',
                "hide": True
            }
        ]
    },
    "chap2_22": {
        "text": '''Поздравляем, с прохождением пролога! Открыта новая команда "Меню", тут ты сможешь посмотреть свои квесты и открытые способности и многое другое! Для продолжения скажи "Меню".''',
        "tts": '''Поздравляем, с прохождением пролога! Открыта новая команда "Меню", тут ты сможешь посмотреть свои квесты и открытые способности и многое другое! Для продолжения скажи "Меню".''',
        "buttons": [
            {
                "title": 'Меню',
                "hide": True
